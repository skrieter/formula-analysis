 ...
 */
public class FastRandomAlgorithm extends RandomAlgorithm<FastRandomConfigurationGenerator> {

	@Override
	protected FastRandomConfigurationGenerator createConfigurationGenerator() {
